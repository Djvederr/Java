package PictureLab.classes.classes;
...
public class Picture extends SimplePicture
{
  ...
  {
      String location="C:\\Users\\vedmh\\IdeaProjects\\APJava\\src\\PictureLab\\images\\images\\jenny-red.jpg";
    Picture beach = new Picture(location);
    Picture beach2= new Picture(location);
    Picture beach3= new Picture(location);
    Picture beach4= new Picture(location);
    beach.explore();
    beach.zeroRed();
    beach.explore();
    beach2.zeroGreen();
